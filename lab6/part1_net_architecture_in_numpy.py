...
def zad2_two_layer_net(student_id):
    ...
    model.hidden_layer.W[:, 0] = [0.9, 0.5]     # wagi neuronu h1
    model.hidden_layer.W[:, 1] = [0.8, 1]     # wagi neuronu h2
    model.hidden_layer.b[:] = [0.5, 0.2]      # biasy neuronów h1 i h2
    model.output_layer.W[:, 0] = [0.3, 0.45]         # wagi neuronu wyjściowego
...
if __name__ == '__main__':
    ...
    student_id = 193557         # Twój numer indeksu, np. 102247
