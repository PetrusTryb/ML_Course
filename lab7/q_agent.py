...
class QAgent(Agent):
    ...
    def init_q_table(self, initial_q_value=0.):
        ...
        q_table = np.zeros((self.n_states, len(self.action_space)))
        q_table.fill(initial_q_value)
        return q_table
    ...
    def choose_action(self, state: State) -> Action:
        ...
        return np.argmax(self.q_table[state, :])  # na razie agent zawsze wybiera akcję "idź do góry"
